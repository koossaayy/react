...
export default function DeleteUser() {
  ...
  return <div className="space-y-6">
            <Heading variant="small" title={t('Delete account')} description="Delete your account and all of its resources" />
            ...
            preserveScroll: true
              ...
              errors
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="password" type="password" name="password" ref={passwordInput} placeholder={t('Password')} autoComplete="current-password" />
