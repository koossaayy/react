...
export default function Login({
  ...
  return <AuthLayout title={t('Log in to your account')} description="Enter your email and password below to log in">
            <Head title={t('Log in')} />
        ...
        errors
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="password" type="password" name="password" required tabIndex={2} autoComplete="current-password" placeholder={t('Password')} />
